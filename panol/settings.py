...
SECRET_KEY = 'django-insecure-ass=lqhhnpt@_a4dxivoyu(s8a)j=d1b%^w_c!yno-kwgj3lb%'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'panol_db',     # nombre de la BD en phpMyAdmin
        'USER': 'root',         # usuario por defecto de XAMPP
        'PASSWORD': '',         # deja vacío si no pusiste clave
        'HOST': 'localhost',    # OJO: localhost, bien escrito
        'PORT': '3306',
    }
}
...
# Después de un login exitoso: ir al menú principal
LOGIN_REDIRECT_URL = 'menu_principal'

# URL del login (la que provee django.contrib.auth.urls)
LOGIN_URL = 'login'
